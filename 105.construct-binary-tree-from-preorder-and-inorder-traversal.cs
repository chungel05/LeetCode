...
public partial class Solution
{
    public TreeNode BuildTree(int[] preorder, int[] inorder)
    {
        ...
        // preroder takes exclude the root and take mid elements
        // inorder takes mid elements before root
        root.left = BuildTree(preorder.Skip(1).Take(mid).ToArray(), inorder.Take(mid).ToArray());
        // preorder takes elements after root and mid elements
        // inorder takes elements after root, which is exclude mid element and +1 root
